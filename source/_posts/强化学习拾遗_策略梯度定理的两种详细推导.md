---
title: 强化学习拾遗 —— 策略梯度定理的两种详细推导
date: 2026-02-02 21:06:15
tags:
  - 强化学习
categories:
  - 机器学习
  - 强化学习
index_img: img/强化学习拾遗_策略梯度定理的两种详细推导\index.png
description: 本文详细探讨了策略梯度定理的两种推导方法，说明了两种策略梯度适用的算法，以及二者间的转换关系
---

- 首发链接：[强化学习拾遗 —— 策略梯度定理的两种详细推导](https://blog.csdn.net/wxc971231/article/details/157615611)
